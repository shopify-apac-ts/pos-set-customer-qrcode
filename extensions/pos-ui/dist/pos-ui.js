...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // node_modules/@shopify/retail-ui-extensions/build/esm/components/CameraScanner/CameraScanner.mjs
  var CameraScanner = createRemoteComponent("CameraScanner");
  ...
  // extensions/pos-ui/node_modules/@shopify/retail-ui-extensions-react/build/esm/extension-api/scanner-api/scanner-api.mjs
  var import_react8 = __toESM(require_react(), 1);
  var statefulScannerDataSubscribable;
  var isScannerApi = (api) => {
  ...
  function useScannerDataSubscription() {
    ...
    const [scanResult, setScanResult] = (0, import_react8.useState)(statefulSubscribableScanner.current);
    const unsubscribeRef = (0, import_react8.useRef)();
    (0, import_react8.useEffect)(() => {
      if (!unsubscribeRef.current) {
        statefulSubscribableScanner.subscribe((scanResult2) => {
  ...
  // extensions/pos-ui/node_modules/@shopify/retail-ui-extensions-react/build/esm/components/CameraScanner/CameraScanner.mjs
  var CameraScanner2 = createRemoteReactComponent(CameraScanner);

  // extensions/pos-ui/node_modules/@shopify/retail-ui-extensions-react/build/esm/components/Stack/Stack.mjs
  ...
  var SmartGridModal = () => {
    ...
    (0, import_react14.useEffect)(() => {
      const addCustomerToCart = (data2) => {
        if (data2) {
          api.cart.setCustomer({ id: Number(data2) });
        }
      };
      addCustomerToCart(data);
    }, [data]);
    const scannedData = `${((_a = cart == null ? void 0 : cart.customer) == null ? void 0 : _a.email) || ""}`;
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Navigator2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Screen2, { name: "reader_screen", title: scannedData, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Stack2, { direction: "vertical", flexChildren: true, flex: 1, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CameraScanner2, {}) }) }) });
  };
